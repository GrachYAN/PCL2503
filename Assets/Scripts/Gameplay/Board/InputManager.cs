...
public class InputManager : MonoBehaviour
{
    ...
    /// 播放棋子选中升起动画
    /// </summary>
    private void PlayPieceSelectionAnimation(Piece piece)
    {
        if (piece == null) return;
        
        // 使用动画系统播放升起动画
        piece.MotionAnimator.PlayLiftAnimation();
    }

    /// <summary>
    /// 播放棋子取消选中落下动画
    /// </summary>
    private void PlayPieceDeselectionAnimation(Piece piece)
    {
        if (piece == null) return;
